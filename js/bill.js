  ...
  $.ajax({
    ...
    success:function(para)
    {
      ...
      for(let i=0;i<problems.length;i++)
      {
          ...
          {
            s2+='<tr class="item last"><td>'+problems[i].problem+'</td><td>'+problems[i].subproblem+'</td><td>'+problems[i].price+'</td></tr>'
          }
          else
          {
            s2+='<tr class="item"><td>'+problems[i].problem+'</td><td>'+problems[i].subproblem+'</td><td>'+problems[i].price+'</td></tr>'
          } 
      }
