...
while($row_admin = mysqli_fetch_array($run_admin)){
    array_push($cancelled,["MR".sprintf("%05d", $row_admin['rid']),$row_admin['username'],$row_admin['mcname'],$row_admin['mmname'],$row_admin['calprice'],$row_admin['phonenum'],$row_admin['pincode'],$row_admin['main_problem'],$row_admin['sub_problem'],$row_admin['address'],$row_admin['rid'],$row_admin['warrenty'],$row_admin['creason'],$row_admin['status']]);
}
