...
while($row_admin = mysqli_fetch_array($run_admin)){
   array_push($arr,["rid"=>$row_admin['rid'],"date"=>$row_admin['date'],"time"=>$row_admin['time'],"username"=>$row_admin['username'],"phonenum"=>$row_admin['phonenum'],"address"=>$row_admin['address'],"admin_name"=>$row_admin['admin_name'],"status"=>$row_admin['status'],"delivery_status"=>$row_admin['delivery_status'],"warranty"=>$row_admin['warranty'],"orderid"=>"MR".sprintf("%05d", $row_admin['rid']),"imeino"=>$row_admin['imeino'],"mcname"=>$row_admin['mcname'],"mmname"=>$row_admin['mmname'],"pay_status"=>$row_admin['pay_status'],"pay_method"=>$row_admin['pay_method']]);
